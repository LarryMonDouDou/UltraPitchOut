...
public class UltraSpec implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender var1, Command var2, String var3, String[] var4) {
        if (var1 instanceof Player && var4.length == 0 && var1.isOp()) {
            ...
            config.save();
            var1.sendMessage("§dUltra §7>> §aLe Point de spawn du spectator a été set");
        } else {
            var1.sendMessage("§dUltra §7>> §4Erreur ");
        }
